...
export function TaskForm({ pageTitle, submitLabel, initial, onCancel, onSubmit }) {
    ...
    <div style={{ flex: 1, overflowY: "auto", padding: "32px" }}>
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        <div style={{ marginBottom: 28 }}>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: C.dark, marginBottom: 4 }}>
            {pageTitle}
          </h1>
        ...
        <div style={{ backgroundColor: C.white, borderRadius: 14, padding: 32, boxShadow: SH_MD }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6 }}>
                  ...
                  />
                  <span style={{ fontSize: 11, color: C.mid }}>{priority} priority</span>
                </div>
              </div>
              <div>
                <Label>Status</Label>
            ...
            >
              ...
              {important && (
                <svg style={{ marginLeft: "auto" }} width="18" height="18" viewBox="0 0 24 24" fill={C.warning}>
