...
const getInitialForm = (task) => {
  ...
  return {
    ...
    dueDate: rawDueDate ? String(rawDueDate).slice(0, 10) : "",
  };
};
...
function TaskForm({
  ...
  // Use a state initializer function so it computes the correct initial state
  // once per mount/task change, avoiding useEffect entirely.
